    			...
    			<!-- signup.jsp -->
	 			<div class="col-md-4 col-md-offset-4 col-xs-4 col-xs-offset-4">
	 				<div class="div-center max-width-400">
		            	...
		            	<!-- 회원가입 폼 -->
		           		<form method="post" name="signUpForm" role="form" action="/gonggu/mypage/info/modifypro" onsubmit="return checkConditionSignUpFrom()">
		                    ...
		                    <div class="form-group">
		                        <input type="password" class="form-control" name="password" placeholder="비밀번호 입력" value="${memberDto.password}" onkeyup="checkValidationPassword()">
		                        <h6 id="pwdRegErr" class="help-block">8글자 이상, 특수문자를 조합하여 입력하세요.</h6>
		                    </div>
		                    <div class="form-group">
		                        <input type="password" class="form-control" name="repassword" placeholder="비밀번호 확인" value="${memberDto.password}" onkeyup="checkValidationRePassword()">
		                        <h6 id="rePwdErr" class="help-block">비밀번호와 일치하지 않습니다. 다시 입력해 주세요.</h6>
		                    </div>
		                    <div class="form-group">
		                        <input type="text" class="form-control" name="nickname" placeholder="닉네임" value="${memberDto.nickname}" onkeyup="checkValidationNickName()">
		                    ...
		                    <div class="form-group">
		                     ...
		                     <div class="form-group">
		                    	<input type="text" class="form-control" name="tel" placeholder="전화번호" value="${memberDto.tel}" onkeyup="checkValidationTeleNum()">
		                    ...
		                    <div class="form-group mar-bottom-100">
		                    	<div class="row">
		                    		...
		                    		<div class="col-md-6 col-xs-6">
		                    			<button type="button" class="btn btn-danger width-100p height-40" onclick="location='#'">탈퇴하기</button>
		                    		</div>
		                    	</div>
		                    </div>
		                </form>        
